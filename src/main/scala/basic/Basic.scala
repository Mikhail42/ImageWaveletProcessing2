...
object Basic {
  ...
  */
  ...
  def createM(m: Int, n: Int): Array[Array[T]] = Array.ofDim[T](m, n)

  def createMBool(m: Int, n: Int): Array[Array[B]] = Array.ofDim[B](m, n)
  ...
  def createMInt(m: Int, n: Int): Array[Array[Int]] = Array.ofDim[Int](m, n)
